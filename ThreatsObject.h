...
#define THREAT_FRAME_NUM 20
#define THREAT_SPEED 3
#define SIZE_THREAT 96
...
public:
    ...
    void set_check_dynamic(const int& dynamic) { check_dynamic = dynamic; };
    int dynamic() { return check_dynamic; };
